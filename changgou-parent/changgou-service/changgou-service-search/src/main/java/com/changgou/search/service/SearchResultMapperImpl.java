        ...
        for (SearchHit searchHit : response.getHits()) {
            ...
            if(highlightField!=null){
                ...
                for (Text text : highlightField.getFragments()) {
                    String string = text.toString();//高亮的数据  华为 胀奸  5寸  联通2G  白  <em style='color=red>'显示</em>  32G  16G  300万像素
                    buffer.append(string);
                }
                skuInfo.setName(buffer.toString());//将非高亮替换成高亮数据
            }
