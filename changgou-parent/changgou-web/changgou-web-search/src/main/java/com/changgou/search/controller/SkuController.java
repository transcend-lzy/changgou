...
public class SkuController {
    ...
    public String search(@RequestParam(required = false) Map<String, String> searchMap, Model model) {
        ...
        model.addAttribute("urlSort",urls[1]);
        ...
        Page<SkuInfo> infoPage = new Page<SkuInfo>(
                ...
                Integer.valueOf(resultmap.get("totalPages").toString())
        );
    ...
    private String[] url(Map<String, String> searchMap) {
        ...
        String urlSort = "/search/list";
        String urlPage = "/search/list";
        if(searchMap!=null && searchMap.size()>0){
            ...
            for (Map.Entry<String, String> stringStringEntry : searchMap.entrySet()) {
                ...
                if(key.equalsIgnoreCase("sortField") || key.equalsIgnoreCase("sortRule")){
                    continue;   //如果是排序url的话，应该忽略原来的排序参数
                }
                urlSort+=key+"="+value+"&";
            }
            ...
            if(url.lastIndexOf("&")!=-1){
                ...
                urlSort =  urlSort.substring(0,urlSort.lastIndexOf("&"));
            }

        }
        return new String[]{url, urlSort, urlPage};
    }
    @GetMapping("/success")
